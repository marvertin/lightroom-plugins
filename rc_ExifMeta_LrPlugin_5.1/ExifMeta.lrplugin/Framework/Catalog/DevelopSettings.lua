...
DevelopSettings.table = { -- static table with all info for all settings.
    ...
    {   groupName = "Camera Calibration",
        members = {
            ...
            { id='CameraProfile', friendly="Camera Profile", dataType = 'string' }, -- constraints = "Canon PowerShot G12 Adobe Standard (RC Debright)", -- ###3
    ...
    {   groupName = "Enable/Disable Groups",
        members = {
            { members={
                { id='EnableToneCurve', friendly="Enable Tone Curve (broken? ###3)", dataType = 'boolean' }, -- ###3 don't think this works.
            }},
